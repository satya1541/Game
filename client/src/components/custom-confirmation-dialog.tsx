...
export default function CustomConfirmationDialog({ 
  ...
  return (
    ...
    >
      <div 
        className="p-6 max-w-md w-full mx-4 animate-in zoom-in-95 duration-150 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border border-white/30 dark:border-gray-700/50 shadow-2xl rounded-2xl"
