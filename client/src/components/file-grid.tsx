        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {folders.map((folder: any) => (
              <div
                key={folder.name}
                className="folder-card aqua-hover rounded-xl p-6 cursor-pointer group relative overflow-hidden hover:scale-105 transition-all duration-200 shadow-lg shadow-black/30 hover:shadow-xl hover:shadow-black/40"
          ...
          {files.map((file: any) => {
            ...
            return (
              <div 
                key={file.id} 
                className={cn(
                  "file-card aqua-hover rounded-xl p-6 group relative overflow-hidden",
