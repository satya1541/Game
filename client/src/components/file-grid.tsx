        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {folders.map((folder: any) => (
              <div
                key={folder.name}
                className="glass-card cursor-pointer group relative overflow-hidden p-6"
              ...
              >
                ...
                <h3 className="text-lg font-gaming font-bold text-foreground mb-2 group-hover:text-primary" style={{ transition: 'color 0.1s ease' }}>
                  {folder.name} Files
                </h3>
              ...
              >
                ...
                {viewMode === 'grid' ? (
                  <>
                    ...
                    <h4 className="font-gaming font-bold text-foreground mb-2 group-hover:text-primary truncate" style={{ transition: 'color 0.1s ease' }} data-testid={`file-name-${file.id}`}>
                      {file.originalName}
                    </h4>
