  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8" id="upload">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-4xl md:text-6xl font-gaming font-bold mb-6 text-[#de5c5c] animate-float">
          UPLOAD YOUR FILES
        </h2>
        ...
        <div 
          className={cn(
            "glass-card cursor-pointer relative overflow-hidden p-12 mb-8 hover:bg-background/30 hover:border-primary/30 transition-all duration-300",
            isDragOver && "bg-primary/10 border-primary/40 scale-[1.02]"
          )}
        ...
        {uploadMutation.isPending && (
          <div className="glass-card p-6" data-testid="upload-progress">
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            ...
            <div className="space-y-3">
              {userFiles.map((file: any) => (
                <div key={file.id} className="glass-card p-4 hover:bg-background/30 transition-all duration-200">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 glass-light border border-primary/20 rounded-lg flex items-center justify-center">
                        <img 
