  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8" id="upload">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div 
          className={cn(
            "glass-card cursor-pointer relative overflow-hidden p-12 mb-8 hover:bg-background/30 hover:border-primary/30 transition-all duration-150",
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            ...
            <div className="space-y-3">
              {userFiles.map((file: any) => (
                <div key={file.id} className="glass-card p-4 hover:bg-background/30 transition-all duration-150">
