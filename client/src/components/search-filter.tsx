    ...
    <section className="py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mb-12">
          <div className={`relative w-full max-w-2xl transition-all duration-150 ${
            ...
            <div className="relative z-10 p-2">
              <div className="relative">
                {/* Search Icon */}
                <div className={`absolute left-4 top-1/2 transform -translate-y-1/2 transition-all duration-150 z-20 ${
                ...
                <Input
                  ...
                  className={`pl-16 pr-16 py-6 text-lg rounded-xl border-0 bg-transparent focus:ring-0 focus:outline-none focus-visible:ring-0 focus-visible:outline-none focus:border-transparent focus-visible:border-transparent placeholder:text-muted-foreground/70 transition-all duration-150 ${
                ...
                {/* Filter Icon */}
                <div className={`absolute right-6 top-1/2 transform -translate-y-1/2 transition-all duration-150 z-20 ${
                  isFocused ? 'scale-110' : 'scale-100'
                }`}>
        ...
        {!selectedFolder && searchQuery && (
          <div className="text-center space-y-4">
            ...
            <Button
              ...
              variant="outline"
              className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 hover:from-cyan-500/20 hover:to-blue-500/20 border-cyan-400/50 text-cyan-500 font-semibold hover:text-cyan-400 transition-all duration-150 shadow-lg hover:shadow-cyan-500/25"
