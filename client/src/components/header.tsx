...
export default function Header() {
  ...
  return (
    <header className="relative z-50 border-b border-border/50 backdrop-blur-lg bg-black/60">
        ...
        <div className="flex items-center justify-between h-16 w-full">
          ...
          <Link href="/">
            <div className="flex items-center space-x-3 cursor-pointer">
              ...
              <div>
                <h1 className="text-xl font-gaming font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                  H4VX
                </h1>
