...
export default function CustomPopup({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="max-w-md w-full mx-4 animate-in fade-in-0 zoom-in-95 duration-200 overflow-hidden bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border border-white/30 dark:border-gray-700/50 shadow-2xl rounded-2xl">
